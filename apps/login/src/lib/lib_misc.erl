		...
		_ ->
			try packet:pack(Cmd, Result) of
		        ...
		        Class:Reason:Stacktrace ->
		            lager:error("Cmd:~p, Result:~p, packet_and_send error:~s", [Cmd, Result, lager:pr_stacktrace(Stacktrace, {Class, Reason})])
		    end
	end.
		...
		_ ->
			try packet:pack(Cmd, Data) of
		        ...
		        Class:Reason:Stacktrace ->
		            ...
		            lager:error("~n send_dataout error:~s", [lager:pr_stacktrace(Stacktrace, {Class, Reason})])
		    end
	end.
